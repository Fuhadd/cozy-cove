...
import 'package:cozy_cove/screens/quest/friend_quest_details_screen.dart';
import 'package:cozy_cove/utils/spacers.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class FriendsQuestListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: friendQuestLists.length,
      itemBuilder: (context, index) {
        var chat = friendQuestLists[index];
        return GestureDetector(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => const FriendQuestDetailsScreen(
                    // title: chat.title,
          ...
          child: Column(
            children: [
              ...
              verticalSpacer(10),
              index == friendQuestLists.length - 1
