...
//           payer: phantom.phantomWalletPublicKey,
//           recentBlockhash: (await connection.getLatestBlockhash()).blockhash,
//           instructions: [
//             SystemProgram.transfer(
//               fromPubkey: phantom.phantomWalletPublicKey,
//               toPubkey: phantom.phantomWalletPublicKey,
//               lamports: web3.solToLamports(1),
//             ),
//           ]);
...
//         Buffer transactionSerialize = transaction.serialize(
//             const web3.TransactionSerializableConfig(
...
//         });
//         // web3.Pubkey
//         final web3.Pubkey programId = web3.Pubkey.fromString(
...
//             .serialize(const web3.TransactionSerializableConfig(
//                 requireAllSignatures: false))
//             .asUint8List());
